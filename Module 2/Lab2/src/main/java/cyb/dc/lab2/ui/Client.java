package cyb.dc.lab2.ui;

import cyb.dc.lab2.dao.ItemDAO;
import cyb.dc.lab2.dao.SectionDAO;
import cyb.dc.lab2.dto.ItemDTO;
import cyb.dc.lab2.dto.SectionDTO;
...
public class Client {
    ...
    private void onUpdateSection() {
        ...
        if (SectionDAO.update(new SectionDTO(id, name))) {
            resultLabel.setText("Done!");
        } else {
            resultLabel.setText(ERROR_MESSAGE);
        }
    ...
    private void onUpdateItem() {
        ...
        if (ItemDAO.update(new ItemDTO(id, sectionId, name, price))) {
            resultLabel.setText("Done!");
        } else {
            resultLabel.setText(ERROR_MESSAGE);
        }
